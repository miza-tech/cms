...
class ResetBackendPasswordModal extends React.Component {
	...
	onSubmit () {
		...
		validateFieldsAndScroll((errors) => {
			...
			this.props.dispatch({
				type: 'backendUser/resetPassword',
				payload: {
					id: editRecord.id,
...
ResetBackendPasswordModal.propTypes = {
...
export default connect(mapStateToProps)(Form.create()(ResetBackendPasswordModal));