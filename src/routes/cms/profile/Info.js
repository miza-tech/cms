...
class Info extends React.Component {
	...
	render() {
		...
		const roles = this.props.cmsRole.roles || [];
		...
		return (
			<div>
				...
				<Card className={styles.card} title="用户权限" loading={this.props.loading}>
...
function mapStateToProps({ app, cmsRole, loading }) {
	return { app, cmsRole, loading: loading.models.cmsRole };
}
