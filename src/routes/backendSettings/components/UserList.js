...
import { Table, Icon, Button, Tooltip, Col, Row, Popconfirm, Badge, Input, TreeSelect, Select, Form } from 'antd';
...
class UserList extends React.Component {
	...
	render() {
		...
		const paginationConf = this.props.administrator.users_pagination;
		let pagination;
		if (paginationConf) {
			pagination = {
				...paginationConf
