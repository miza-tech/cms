...
class DepartmentList extends React.Component {
	...
	deleteRecord (record) {
		this.props.dispatch({
			type: 'administrator/deleteDepartment',
			payload: {
				id: record.id
			}
		});
	...
	render() {
		...
		const departments = this.props.administrator.departments || [];
		...
		return (
			<div>
				...
				<Table columns={columns} dataSource={this.props.administrator.departments}
